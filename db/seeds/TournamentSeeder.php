...
class TournamentSeeder extends AbstractSeed
{
    ...
    public function run(): void
    {
        ...
        $tablesData = [
            // 1回戦
            ['round_number' => 1, 'table_name' => '1卓', 'schedule' => '',           'done' => true],
            ['round_number' => 1, 'table_name' => '2卓', 'schedule' => '金曜 21:00', 'done' => true],
            ['round_number' => 1, 'table_name' => '3卓', 'schedule' => '土曜 21:00', 'done' => true],
            ['round_number' => 1, 'table_name' => '4卓', 'schedule' => '日曜 13:00', 'done' => true],
            ['round_number' => 1, 'table_name' => '5卓', 'schedule' => '日曜 22:00', 'done' => true],
            // 2回戦
            ['round_number' => 2, 'table_name' => '1卓', 'schedule' => '', 'done' => true],
            ['round_number' => 2, 'table_name' => '2卓', 'schedule' => '', 'done' => true],
            ['round_number' => 2, 'table_name' => '3卓', 'schedule' => '', 'done' => true],
            ['round_number' => 2, 'table_name' => '4卓', 'schedule' => '', 'done' => true],
            // 3回戦
            ['round_number' => 3, 'table_name' => '1卓', 'schedule' => '',       'done' => true],
            ['round_number' => 3, 'table_name' => '2卓', 'schedule' => '日曜夜', 'done' => true],
            ['round_number' => 3, 'table_name' => '3卓', 'schedule' => '',       'done' => true],
        ];
        ...
        // 総合順位
        $standingsData = [
            ['あはん',1,130.4,false,3],  ['みか',2,118.0,false,0],
            ['がちゃ',3,114.3,false,0],  ['ホロホロ',4,102.9,false,0],
            ['ぎり',5,56.5,false,3],     ['シーマ',6,55.5,false,3],
            ['みーた',7,47.8,false,3],   ['こいぬ',8,40.3,false,1],
            ['あき',9,-0.7,false,3],     ['するが',10,-1.2,false,0],
        ...
        $this->table('tournament_meta')->insert([
            ['key' => 'record_score',      'value' => '65400'],
            ['key' => 'record_player',     'value' => 'するが'],
            ['key' => 'total_players',     'value' => '20'],
            ['key' => 'current_round',     'value' => '3'],
            ['key' => 'remaining_players', 'value' => '4'],
        ])->save();
    }
}
